...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    TRAINER_CLASS(CAMPER, "CAMPER", 4, ITEM_NEST_BALL),
    ...
    TRAINER_CLASS(POKEFAN, "POKéFAN", 20, ITEM_FRIEND_BALL),
    ...
    TRAINER_CLASS(NINJA_BOY, "NINJA BOY", 3, ITEM_DUSK_BALL),
    ...
    TRAINER_CLASS(SALON_MAIDEN, "SALON MAIDEN", 50),
    TRAINER_CLASS(DOME_ACE, "DOME ACE", 50),
    TRAINER_CLASS(PALACE_MAVEN, "PALACE MAVEN", 50),
    TRAINER_CLASS(ARENA_TYCOON, "ARENA TYCOON", 50),
    TRAINER_CLASS(FACTORY_HEAD, "FACTORY HEAD", 50),
    TRAINER_CLASS(PIKE_QUEEN, "PIKE QUEEN", 50),
    TRAINER_CLASS(PYRAMID_KING, "PYRAMID KING", 50),
