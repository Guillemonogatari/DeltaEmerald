...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_NINJA_FAN] = { _("NINJA FAN"), 3 },
    [TRAINER_CLASS_KICK_GIRL] = { _("KICK GIRL"), 6 },
