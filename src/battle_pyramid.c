...
static const struct PyramidTrainerEncounterMusic sTrainerClassEncounterMusic[54] =
{
    ...
    {TRAINER_CLASS_KICK_GIRL, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    ...
    {TRAINER_CLASS_REPORTERS, TRAINER_ENCOUNTER_MUSIC_INTERVIEWER},
    ...
    {TRAINER_CLASS_NINJA_FAN, TRAINER_ENCOUNTER_MUSIC_SUSPICIOUS},
    ...
    {TRAINER_CLASS_RICH_GIRL, TRAINER_ENCOUNTER_MUSIC_FEMALE},
...
static const u8 sTrainerTextGroups[50][2] =
{
    ...
    {FACILITY_CLASS_NINJA_FAN, 0},
    {FACILITY_CLASS_KICK_GIRL, 3},
