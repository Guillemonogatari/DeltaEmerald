...
static const u8 sRubyFacilityClassToEmerald[RS_FACILITY_CLASSES_COUNT - 2][2] =
{
    ...
    {RS_FACILITY_CLASS_INTERVIEWER, FACILITY_CLASS_REPORTERS},
    {RS_FACILITY_CLASS_TUBER_F, FACILITY_CLASS_TUBER_F},
    {RS_FACILITY_CLASS_TUBER_M, FACILITY_CLASS_TUBER_M},
    {RS_FACILITY_CLASS_COOLTRAINER_M, FACILITY_CLASS_ACE_TRAINER_M},
    {RS_FACILITY_CLASS_COOLTRAINER_F, FACILITY_CLASS_ACE_TRAINER_F},
    {RS_FACILITY_CLASS_HEX_MANIAC, FACILITY_CLASS_HEX_MANIAC},
    {RS_FACILITY_CLASS_LADY, FACILITY_CLASS_RICH_GIRL},
    ...
    {RS_FACILITY_CLASS_NINJA_BOY, FACILITY_CLASS_NINJA_FAN},
    {RS_FACILITY_CLASS_BATTLE_GIRL, FACILITY_CLASS_KICK_GIRL},
...
} static const sPartnerTrainerTextTables[] =
{
    ...
    {FACILITY_CLASS_RICH_GIRL,             sPartnerTextsLady},
    ...
    {FACILITY_CLASS_KICK_GIRL,           sPartnerTextsBattleGirl},
    ...
    {FACILITY_CLASS_NINJA_FAN,             sPartnerTextsNinjaBoy},
